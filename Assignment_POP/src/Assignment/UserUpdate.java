...
public class UserUpdate extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
        ...
        Button btnUpdate,btnClose,btnSearch;
        
        lblTitle=new Label("User Update Form");
        lblTitle.setStyle("-fx-font-size:16");
        //face,size,and style?
        Font font1=new Font("Courier New",35);
